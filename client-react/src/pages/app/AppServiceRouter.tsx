...
const FunctionsListLoadable: any = lazy(() => import(/* webpackChunkName:"functionslist" */ './functions-list/FunctionsListDataLoader'));
          ...
          return (
            value.token && (
              <Router>
                ...
                <FunctionsListLoadable resourceId={resourceId} path="/functionslist" />
              </Router>
            )
          );
        }}
